...
class DescriptionActivity : AppCompatActivity() {
    ...
    lateinit var btnaddToafv: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnaddToafv = findViewById(R.id.btnAddToFav)
        ...
        if (ConnectionManager().checkConnectivity(this@DescriptionActivity)) {
            val jsonRequest =
                object : JsonObjectRequest(Method.POST, url, jsonParams, com.android.volley.Response.Listener {
